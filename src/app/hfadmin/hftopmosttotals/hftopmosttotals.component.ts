...
@Component({
  selector: 'app-hftopmosttotals',
  templateUrl: './hftopmosttotals.component.html',
  styleUrls: ['./hftopmosttotals.component.css']
})
export class HftopmosttotalsComponent implements OnInit {
