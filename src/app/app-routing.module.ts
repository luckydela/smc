...
const routes: Routes = [
  ...
  {path:'mconfirmpassword', component: McnfmpasswordComponent}
...
HfloginComponent, HfsidemenuComponent, HfdashbdComponent, HfprofileComponent, ManagertblComponent,
  ...
  SupportComponent, AddvehicleComponent, ResetComponent,ExpiredLinkComponent,ResetSuccessAppComponent,
